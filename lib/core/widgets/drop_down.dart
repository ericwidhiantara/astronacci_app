        ...
        children: [
          ...
          ButtonTheme(
            ...
            child: DropdownButtonFormField<T>(
              isExpanded: true,
              dropdownColor: Theme.of(context).extension<CustomColor>()!.card,
              ...
              decoration: InputDecoration(
                ...
                isCollapsed: true,
                filled: true,
                fillColor: Theme.of(context).extension<CustomColor>()!.card,
                prefixIcon: Padding(
                ...
                enabledBorder: OutlineInputBorder(
                  ...
                  borderSide: BorderSide(
                    color: Theme.of(context).extension<CustomColor>()!.card!,
                  ),
                ),
