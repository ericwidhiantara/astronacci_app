class SvgImages {
  ...
  static String icArrowUp = "assets/svg/ic_arrow_up.svg";
  static String icEmptyState = "assets/svg/ic_empty_state.svg";
  static String icMenuHome = "assets/svg/ic_menu_home.svg";
}
